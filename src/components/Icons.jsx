export const LuramiClothing = ({ className }) => {
	return (
		<svg
            ...
            fill="currentColor"
			className={className ?? ''}>
			<path d="M123.5,34.7v2.7h-0.7v-2.7h-0.9v-0.6h2.6v0.6H123.5z M127.4,37.5v-2.6l-0.7,2.6h-0.6l-0.7-2.7l0,2.7h-0.7v-3.3h1.1l0.6,2.3l0.6-2.3h1.1v3.3H127.4z" />
			<path
				d="M18.2,64c-7,0-12.6-4.8-13.5-11.5c-0.5-3,0.1-6,1.7-8.5c1.4-2.2,3.5-3.6,5.8-4.5c2.3-0.9,4.8-1.5,7.3-1.7
			...
			/>
			<path
				d="M36.2,22.8c0,6.6-5.3,11.9-11.9,11.9c-6.6,0-11.9-5.3-11.9-11.9s5.3-11.9,11.9-11.9c0.1,0,0.2,0,0.3,0
                C31.1,11.1,36.2,16.3,36.2,22.8z"
			/>
			<path
				d="M9.3,35.1c0,2.6-2.1,4.6-4.7,4.6C2,39.7,0,37.6,0,35.1c0-2.5,2.1-4.6,4.6-4.6C7.2,30.5,9.3,32.5,9.3,35.1
                C9.3,35.1,9.3,35.1,9.3,35.1z"
			/>
			<path d="M46.6,51.7v-13h3.2v10.3h5.1v2.7H46.6z" />
			<path
				d="M67.4,48.7c-1.1,3-4.5,3.2-5.3,3.2c-0.6,0-2.7-0.1-4.2-1.6c-1.3-1.3-1.3-2.9-1.3-4.5v-7.3h3.3v8.1c0,1.2,0.1,1.6,0.6,2
                c0.5,0.3,1.1,0.5,1.7,0.5c0.6,0.1,1.1-0.1,1.6-0.5c0.6-0.5,0.6-1.3,0.6-2v-8.1h3.3v7.3C67.8,46.9,67.6,47.8,67.4,48.7z"
			/>
			<path
				d="M78.6,51.7L76,47h-2v4.6h-3.3v-13h5.9c0.4,0,0.7,0,1.1,0c0.6,0,2.7,0.2,3.7,2c0.3,0.7,0.5,1.4,0.5,2.2c0.1,1-0.3,2-1,2.7
			...
			<path
				d="M73.1,62.5c-0.5,0.6-1.7,1.3-3.6,1.3c-0.4,0-0.8,0-1.2-0.1c-1.2-0.1-2.3-0.8-2.9-1.8c-0.8-1.4-0.7-3.2,0.2-4.5
